...
import { Plus, Settings, Search, Building2, LayoutDashboard, HelpCircle } from 'lucide-react'
    ...
    <CommandDialog open={open} onOpenChange={setOpen} title="Command Palette" description="Search for a command to run...">
      ...
      <CommandList>
        ...
        <CommandGroup heading="Quick">
          <CommandItem
            onSelect={() => {
              toast({ title: 'Search opened', description: 'Use the directory search or browse /listings.' })
              router.push('/search')
              setOpen(false)
            }}
          >
